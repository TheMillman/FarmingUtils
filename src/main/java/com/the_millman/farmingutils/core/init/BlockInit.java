...
import com.the_millman.farmingutils.common.blocks.AdvancedComposterBlock;
...
public class BlockInit {
	...
	public static final RegistryObject<Block> MUSHROOM_FARMER = BLOCKS.register("internal_farmer", () -> new InternalFarmerBlock(BlockBehaviour.Properties.of(Material.STONE).strength(4.0F).requiresCorrectToolForDrops().sound(SoundType.METAL)));
	public static final RegistryObject<Block> COMPOSTER = BLOCKS.register("composter", () -> new AdvancedComposterBlock(BlockBehaviour.Properties.of(Material.STONE).strength(4.0F).requiresCorrectToolForDrops().sound(SoundType.METAL)));
