...
public class BambooFarmerScreen extends ItemEnergyScreen<BambooFarmerContainer> {
	private ResourceLocation GUI = LibResources.THREE_FOR_THREE_GUI;
	private ResourceLocation OVERLAY = LibResources.OFFSETS;
	
	public BambooFarmerScreen(BambooFarmerContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
